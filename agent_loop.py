...
AIDER_MODEL    = 'claude-sonnet-4-5'
FLIGHT_DURATION = 30

PROMPTS = {
"CRASH": f"The drone CRASHED (roll/pitch >60°). In {FIRMWARE_DIR}/main.c reduce K_po by 20% (0.8→0.64) and K_pi by 20% (0.035→0.028). Explain changes.",
"OSCILLATING": f"The drone OSCILLATED. In {FIRMWARE_DIR}/main.c reduce K_pi by 15% and increase K_di by 20%. In attitude_controller.c increase alpha to 0.025. Explain changes.",
"UNSTABLE": f"The drone is UNSTABLE. In {FIRMWARE_DIR}/main.c increase K_po by 10% (0.8→0.88). Explain changes.",
}
...
while iteration < MAX_ITERATIONS:
    ...
    print(f"\n  Iteration {iteration} done. Restarting in 3s..."); time.sleep(3)
